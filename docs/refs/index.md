...
<a id="9840_s"></a>[🔦 Guidelight System](#9840)
...
----------
### <a id="0580"></a>Bloodvine

`📑 Term`

Bloodvine or a stranger vine is a type of carnivore plant that grows in the shallower parts of [Oblivion Mire](#8840). It's known for its strength with which the vines can pull in and even trap the largest of creatures.
...
----------
### <a id="9840"></a>🔦 Guidelight System

`🖼️ Landmark` in [Oblivion Mire](#8840)

Completed on eon 805 by [MindTech Institute](#6550), this system provides guidance to travelers through the treacherous swamps of _Oblivion Mire_.
...
- The Primary Path goes from west to east, connecting [Timeless Desert](#0130) to [A'as Forest](#dd50), with a separate branch going towards Paradox Pass, connecting directly to [Axonite Road](#a740).
- The Secondary Path going from north to south, connecting [Blue Screen Lagoon](#8f30) to [Cerene Vale](#3850).
...
----------
### <a id="3520"></a>🌌 Stellarium

`🖼️ Landmark` in [Indigo Shore](#7a70)

Built on eon 804 by [Delta Collective](#8bc0)
